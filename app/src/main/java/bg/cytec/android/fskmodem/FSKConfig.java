...
public class FSKConfig {
	...
	public FSKConfig(int sampleRate, int pcmFormat, int channels,
		...
		case SOFT_MODEM_MODE_9:

			this.modemBaudRate = SOFT_MODEM_MODE_9_BAUD_RATE;
			this.modemFreqLow = SOFT_MODEM_MODE_9_LOW_FREQ;
			this.modemFreqHigh = SOFT_MODEM_MODE_9_HIGH_FREQ;
